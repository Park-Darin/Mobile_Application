...
import com.fit2081.fit2081_a1_parkdarin.databinding.ActivityGoogleMapBinding;
...
public class GoogleMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countryToFocus = getIntent().getExtras().getString("EventLocation", "Sydney");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(countryToFocus.equals("") || !isValidAddress(countryToFocus)){
            LatLng sydney = new LatLng(-33.86820106499686, 151.209379516263);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            geocoder.getFromLocationName(countryToFocus, 1, addresses -> {
                if (addresses.isEmpty()){
                    Toast.makeText(GoogleMapActivity.this, "Category Event Location not found", Toast.LENGTH_LONG).show();
                }
                ...
                if (!addresses.isEmpty()) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        mMap.animateCamera(CameraUpdateFactory.zoomTo(10f));
                        Toast.makeText(this, "API Check " + countryToFocus, Toast.LENGTH_LONG).show();
                    });
                }
            });
        }
